...
class EventData: ObservableObject {
    @Published var events: [Event] = [
        ...
        Event(symbol: "theatermasks.fill",
              ...
              date: Date.roundedHoursFromNow(60 * 60 * 28)),
        Event(symbol: "mic.circle.fill",
              color: .red,
              title: "Coornholio Estrus",
              tasks: [EventTask(text: "Buy new tux"),
                      EventTask(text: "Get tickets"),
                      EventTask(text: "Pick up Carmen at the airport and bring her to the show"),
                     ],
              date: Date.roundedHoursFromNow(60 * 60 * 29 * 2)),
        Event(symbol: "car.fill",
              color: .yellow,
              title: "Yellow Cab",
              tasks: [EventTask(text: "Buy new tux"),
                      EventTask(text: "Get tickets"),
              ...
              date: Date.roundedHoursFromNow(60 * 60 * 32)),
        Event(symbol: "speaker.wave.3.fill",
              ...
              date: Date.roundedHoursFromNow(60 * 60 * 44)),
        Event(symbol: "phone.bubble.left.fill",
              color: .mint,
              title: "Phone Call",
              tasks: [EventTask(text: "Buy new tux"),
                      EventTask(text: "Get tickets"),
       ...
       Event(symbol: "facemask.fill",
              ...
              tasks: [EventTask(text: "Bring medical ID"),
                      ...
                      EventTask(text: "Glucose History"),
                     ],
